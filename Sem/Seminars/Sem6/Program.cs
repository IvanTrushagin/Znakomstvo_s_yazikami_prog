// Архип Чижанов Задайте массив символов (тип char []). Создайте строку из
...
// {
//     string result = string.Empty;               //char[] chars = { 'a', 'b', 'c', 'd' };
//     for (int i = 0; i < charArray.Length; i++) // string str = new string(chars);
//     {
...
// Архип Чижанов На основе символов строки (тип string) сформировать массив
